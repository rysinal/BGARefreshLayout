...
package mobi.wonders.apps.android.bgarefreshlayout.utils;
...
import mobi.wonders.apps.android.bgarefreshlayout.R;
...
public class BGANormalRefreshViewHolder extends BGARefreshViewHolder {
    ...
    private String mRefreshingSucessText = "加载完成";
    private String mRefreshingErrorText = "加载失败";
    ...
    public void handleScale(float scale, int moveYDistance) {
        mHeaderArrowIv.setImageResource(R.mipmap.refresh_head_arrow);
    }
    ...
    @Override
    public void onEndRefreshing(boolean state) {
        if(state) {
            mHeaderStatusTv.setText(mRefreshingSucessText);
            mHeaderChrysanthemumIv.setVisibility(View.INVISIBLE);
            mHeaderChrysanthemumAd.stop();
            mHeaderArrowIv.setVisibility(View.VISIBLE);
            mHeaderArrowIv.setImageResource(R.mipmap.refresh_succeed);
        }else {
            mHeaderStatusTv.setText(mRefreshingErrorText);
            mHeaderChrysanthemumIv.setVisibility(View.INVISIBLE);
            mHeaderChrysanthemumAd.stop();
            mHeaderArrowIv.setVisibility(View.VISIBLE);
            mHeaderArrowIv.setImageResource(R.mipmap.refresh_failed);
        }
